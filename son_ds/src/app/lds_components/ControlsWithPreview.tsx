...
const componentMap: Record<
  string,
  React.ComponentType<Record<string, string | boolean>> | undefined
> = {
...
export default function ControlsWithPreview({
  componentName,
  propOptions,
  componentData,
}: previewProps) {
  ...
  >(defaults.selected);
  const [toggledProps, setToggledProps] = React.useState<
